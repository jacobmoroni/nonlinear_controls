...
%    bz       = uu(19+NN); % z-gyro bias
    NN = NN+17;
    pn_c      = uu(1+NN); % commanded north pos (m) 
    pe_c     = uu(2+NN);  % commanded east pos (m)
    h_c     = uu(3+NN);  % commanded altitude (m)
    pndot_c = uu(4+NN);
    pedot_c = uu(5+NN);
    h_dot_c = uu(6+NN);
    psi_c    = uu(7+NN);  % commanded heading angle
    NN = NN+7;
    pnddot_c = uu(1+NN); %feed Forward velocity
    peddot_c = uu(1+NN);%feed Forward velocity
    hddot_c = uu(1+NN);%feed Forward velocity
    psidot_c = uu(1+NN);%feed Forward velocity
    NN = NN + 4;
    t        = uu(1+NN);   % time
